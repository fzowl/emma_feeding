...
const App = ({ signOut }) => {
  ...
  return (
    <View className="App">
      ...
      <View as="footer" className="AppFooter">
        <Flex
          direction="row"
          justifyContent="center"
          alignItems="center"
        ...
        >
          <Text as="span">
            <strong>Today ({dtString}):</strong>
          </Text>
          <Text as="span">Feeds today: {todayCount}</Text>
          <Text as="span">
            Last feed: {lastFeed ? lastFeed : "—"}
          </Text>
          <Text as="span">Stock remaining: {remainingTotal}</Text>
        </Flex>
      </View>
    </View>
  );
