    ...
    <View className="App">
      ...
      <View as="footer" className="App-footer">
        ...
        >
          ...
          <Text as="span">
            Feeds today: <strong>{todayCount}</strong>
          </Text>
          <Text as="span">
            Fed:{" "}
            <strong>{todayNames.length ? todayNames.join(", ") : "—"}</strong>
          </Text>
          <Text as="span">
            Stock remaining: <strong>{stockRemaining}</strong>
          </Text>
        </Flex>
      </View>
    </View>
